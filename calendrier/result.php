<?php 
  ...
  $current_get = $year_get.$month_get.$day_get;
 //echo $current_get ;
?>
...
<div class="article">
  <div class="menu_left">
   <ul>
     ...
     <li class="collapsible"><img align="center" src="<?php echo base_url;?>images/sportscat/primus.jpg" alt="primus" width="30px"> Ihiganwa primus</li>
     <!-- collapse menu -->
     <div class="content">
        <ul>
          <li><a href="./today.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/football.png" alt="primus" width="30px"> Inkino</a></li>
          <li><a href="../classement.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/cup.png" alt="classement" width="30px"> Ugukurikirana</a></li>
          <li><a href="../players.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/playerfoot.png" alt="Abakinyi" width="30px"> Abakinyi</a></li>
          <li><a href="../transfer.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/transfer.png" alt="transfer" width="30px"> Abahagarikizi</a></li>
      ...
      <div class="content">
        <ul>
          ...
          <li><a href="../players.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/playerfoot.png" alt="Abakinyi" width="30px"> League B</a></li>
          <li><a href="../players.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/playerfoot.png" alt="Abakinyi" width="30px"> President's Cup</a></li>
          <li><a href="../players.php"><img align="center" src="<?php echo base_url;?>images/sportsicons/playerfoot.png" alt="Abakinyi" width="30px"> NKURUNZIZA's Cup</a></li>
  ...
  <div class="center">
    ...
    <table class="show_match">
      <?php
        ...
        $req = $conn->query('SELECT * FROM matches WHERE date(date_to_play)='.$current_get.'');
