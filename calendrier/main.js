function generate_year_range(start, end) {
  ...
  var createYear = generate_year_range(2022, currentYear);
  /** or
  ...
  document.querySelectorAll('td.date-picker > span').forEach(element => {
    ...
    // link.href ='result.php?year=' + year + '&month=' + month +'&day=' + day;
    // element.parentElement.appendChild(link);
  
    element.innerHTML = '<a href="#">' + element.textContent + '</a> ';
